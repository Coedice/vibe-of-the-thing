...
| **Preference Flows** | Build election preference-flow scenarios with IRV/STV counting | • Custom candidates and ballot weights<br>• Adjustable seat count and Droop quota<br>• Round-by-round alluvial transfer diagram |
